...
| `/notes/board-notes-dashboard` | `notes:read` | `notes.md` |
| `/notes/board-notes-preview` | `notes:export` | `notes.md` |
| `/notes/board-notes-runbook` | `notes:export` | `notes.md` |
| `/notes/board-notes-dashboard-note` | `notes:write` | `notes.md` |
| `/notes/board-notes-dashboard-note-refresh` | `notes:write` | `notes.md` |
| `/notes/board-notes-dashboard-note-archive` | `notes:write` | `notes.md` |
| `/notes/board-notes-dashboard-note-sync` | `notes:write` | `notes.md` |
| `/notes/board-notes-report` | `notes:write` | `notes.md` |
| `/notes/board-notes-report-refresh` | `notes:write` | `notes.md` |
| `/notes/board-notes-report-archive` | `notes:write` | `notes.md` |
| `/notes/board-notes-report-sync` | `notes:write` | `notes.md` |
| `/notes/board-notes-task` | `notes:write` | `notes.md` |
| `/notes/board-notes-task-refresh` | `notes:write` | `notes.md` |
...
| `/notes/saved-views-batch-apply` | `notes:write` | `notes.md` |
...
| `/notes/work-queue-batch-apply` | `notes:write` | `notes.md` |
...
| `/notes/workboard-note-sync` | `notes:write` | `notes.md` |
| `/notes/work-queue-note` | `notes:write` | `notes.md` |
...
| `/notes/tracking-note-sync` | `notes:write` | `notes.md` |
...
| `/notes/topic-cluster-note-archive` | `notes:write` | `notes.md` |
| `/notes/topic-cluster-note-sync` | `notes:write` | `notes.md` |
...
| `/notes/cleanup-note-sync` | `notes:write` | `notes.md` |
