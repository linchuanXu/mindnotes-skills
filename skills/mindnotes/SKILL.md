...
| Summarize a topic from my notes | Collect enough notes, group by themes, or generate a topic brief before writing | `/notes/search`, `/notes/get`, `/notes/collect`, `/notes/topic-brief` |
