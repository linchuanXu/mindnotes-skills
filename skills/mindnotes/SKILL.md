...
| Review my cleanup/topic trackers | Summarize cleanup reports, cleanup tasks, and topic task notes in one place, sort them by pending/done/snapshot status, open a small priority dashboard, merge them with cleanup actions into one work queue, open one unified workboard that includes recent saved notes, inspect all saved board notes in one overview or one saved-board dashboard, save that dashboard as a reusable note, then archive or batch-sync those saved notes through one unified board-note bridge or through the individual dashboard/queue/workboard note APIs | `/notes/tracking-overview`, `/notes/tracking-status`, `/notes/tracking-dashboard`, `/notes/board-notes`, `/notes/board-notes-dashboard`, `/notes/board-notes-dashboard-note`, `/notes/board-notes-dashboard-note-refresh`, `/notes/board-notes-dashboard-note-archive`, `/notes/board-notes-dashboard-note-sync`, `/notes/board-notes-archive`, `/notes/board-notes-sync`, `/notes/work-queue`, `/notes/workboard`, `/notes/workboard-note`, `/notes/workboard-note-refresh`, `/notes/workboard-note-archive`, `/notes/workboard-note-sync`, `/notes/work-queue-note`, `/notes/work-queue-note-refresh`, `/notes/work-queue-note-archive`, `/notes/work-queue-note-sync`, `/notes/tracking-note`, `/notes/tracking-note-refresh`, `/notes/tracking-note-archive`, `/notes/tracking-note-sync`, `/notes/get` |
...
| Organize folders or tags | Inspect folder tags, hierarchy, move one note, generate a cleanup plan, turn it into action suggestions, preview or apply the next cleanup step, batch-apply the first few write-capable cleanup actions, save a cleanup runbook, save a cleanup execution report, refresh an existing cleanup report note, create a checklist-style cleanup task note, refresh that task note, or review all tracking notes in one overview, status board, priority dashboard, unified work queue, unified workboard, saved board-note overview, saved board-note dashboard, saved board-note dashboard note, unified board-note archive/sync bridge, saved workboard note, saved work queue note, saved tracking note, archived note, or batch-sync flow | `/folders/list`, `/folders/stats`, `/folders/relations`, `/folders/move-note`, `/notes/cleanup-plan`, `/notes/cleanup-actions`, `/notes/cleanup-preview`, `/notes/cleanup-runbook`, `/notes/cleanup-note`, `/notes/cleanup-apply`, `/notes/cleanup-batch-apply`, `/notes/cleanup-report`, `/notes/cleanup-report-refresh`, `/notes/cleanup-task`, `/notes/cleanup-task-refresh`, `/notes/tracking-overview`, `/notes/tracking-status`, `/notes/tracking-dashboard`, `/notes/board-notes`, `/notes/board-notes-dashboard`, `/notes/board-notes-dashboard-note`, `/notes/board-notes-dashboard-note-refresh`, `/notes/board-notes-dashboard-note-archive`, `/notes/board-notes-dashboard-note-sync`, `/notes/board-notes-archive`, `/notes/board-notes-sync`, `/notes/work-queue`, `/notes/workboard`, `/notes/workboard-note`, `/notes/workboard-note-refresh`, `/notes/workboard-note-archive`, `/notes/workboard-note-sync`, `/notes/work-queue-note`, `/notes/work-queue-note-refresh`, `/notes/work-queue-note-archive`, `/notes/work-queue-note-sync`, `/notes/tracking-note`, `/notes/tracking-note-refresh`, `/notes/tracking-note-archive`, `/notes/tracking-note-sync`, `/notes/batch-update` |
